    ...
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="card space-y-6">
        ...
        <div>
          ...
          <input id="invited_by" name="invited_by" type="text" className="input" placeholder="Enter invited by" required />
        </div>
        <div className="flex items-center gap-3">
          <input id="accepted" name="accepted" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-brand-600 focus:ring-brand-500" />
