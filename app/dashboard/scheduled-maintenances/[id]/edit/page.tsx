  ...
  if (!record) {
    return (
      <div className="rounded-lg bg-red-50 border border-red-200 p-4">
        <p className="text-sm text-red-700">Scheduled Maintenance not found.</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mt-2">Edit Scheduled Maintenance</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="card space-y-6">
        ...
        <div>
          ...
          <input id="scheduled_start" name="scheduled_start" type="datetime-local" className="input" defaultValue={String(record.scheduled_start ?? "")} required />
        </div>
        <div>
          <label htmlFor="scheduled_end" className="label">Scheduled End</label>
          <input id="scheduled_end" name="scheduled_end" type="datetime-local" className="input" defaultValue={String(record.scheduled_end ?? "")} required />
        </div>
        <div>
        ...
        <div className="flex items-center gap-3">
          <input id="auto_update_status" name="auto_update_status" type="checkbox" defaultChecked={!!record.auto_update_status} className="h-4 w-4 rounded border-gray-300 text-brand-600 focus:ring-brand-500" />
        ...
        <div className="flex items-center gap-3 pt-4 border-t">
          <button type="submit" disabled={loading} className="btn-primary">
            {loading ? "Saving..." : "Update Scheduled Maintenance"}
          </button>
